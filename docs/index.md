...
De afgelopen week lijkt het dat er 172 zieke gebruikers hun data hebben gedeeld. In de zelfde periode zijn er 3187 mensen positief getest in de regio. Dit betekend dat 5% van de mensen in de regio ook echt hun data deeld als ze ziek zijn. Als nogmaals zoveel mensen de app wel gebruiken om gewaarschuwd te worden (en vervolgens in quarantaine gaan), maar niet zelf hun data willen delen, dan zal de app voor 5% maal 11% = 1% van de ontmoetingen een effect kunnen hebben. Dit percentage gaat er wel vanuit de de ontmoeting niet al via andere middellen was gedetecteerd.
