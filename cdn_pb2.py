...
_TEMPORARYEXPOSUREKEY_REPORTTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="CONFIRMED_TEST", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CONFIRMED_CLINICAL_DIAGNOSIS",
            index=2,
            number=2,
            serialized_options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="SELF_REPORT", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RECURSIVE", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="REVOKED", index=5, number=5, serialized_options=None, type=None
        ),
    ],
...
_TEMPORARYEXPOSUREKEYEXPORT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="revised_keys",
            full_name="TemporaryExposureKeyExport.revised_keys",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
...
_TEMPORARYEXPOSUREKEY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="report_type",
            full_name="TemporaryExposureKey.report_type",
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="days_since_onset_of_symptoms",
            full_name="TemporaryExposureKey.days_since_onset_of_symptoms",
            index=5,
            number=6,
            type=17,
            cpp_type=1,
...
_TEMPORARYEXPOSUREKEYEXPORT.fields_by_name[
    "signature_infos"
].message_type = _SIGNATUREINFO
_TEMPORARYEXPOSUREKEYEXPORT.fields_by_name["keys"].message_type = _TEMPORARYEXPOSUREKEY
_TEMPORARYEXPOSUREKEYEXPORT.fields_by_name[
    "revised_keys"
].message_type = _TEMPORARYEXPOSUREKEY
_TEMPORARYEXPOSUREKEY.fields_by_name[
    "report_type"
].enum_type = _TEMPORARYEXPOSUREKEY_REPORTTYPE
_TEMPORARYEXPOSUREKEY_REPORTTYPE.containing_type = _TEMPORARYEXPOSUREKEY
DESCRIPTOR.message_types_by_name[
    "TemporaryExposureKeyExport"
] = _TEMPORARYEXPOSUREKEYEXPORT
